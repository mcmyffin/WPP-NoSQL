...
public class MainGui extends JFrame implements Runnable { 
    ...
    public boolean commandGui(String command, String parameter) {
        if (command.equals("settings")) {
            ...
            Message m_1 = new Message(System.currentTimeMillis(),client.getSpecialUser(), message, null);
            streamChat.printMessage(m_1);
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                if (ignored && (ignoreMode <= IgnoredMessages.MODE_COUNT || 
                    ...
                    Message message = new Message(System.currentTimeMillis(),user, text, tagEmotes);
